...
class Vendas_model extends CI_Model
{
    ...
    public function get($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        ...
        $this->db->select($fields . ', clientes.nomeCliente, clientes.idClientes, operacao_comercial.nome as operacao_comercial');
        $this->db->from($table);
        ...
        $this->db->join('operacao_comercial', 'operacao_comercial.id = ' . $table . '.operacao_comercial_id', 'left');
    ...
    {
        $this->db->select('vendas.*, clientes.nomeCliente, clientes.documento, usuarios.nome, 
    ...
    {
        $this->db->select('vendas.*, clientes.*, clientes.contato as contato_cliente, clientes.email as emailCliente, lancamentos.data_vencimento, usuarios.telefone as telefone_usuario, usuarios.email as email_usuario, usuarios.nome as nome, operacao_comercial.nome as operacao_comercial');
        $this->db->from('vendas');
    ...
    {
        try {
            $this->db->select('clientes.*, clientes.contato as contato_cliente, clientes.email as emailCliente, clientes.rua as endereco');
            $this->db->from('vendas');
            $this->db->join('clientes', 'clientes.idClientes = vendas.clientes_id');
