...
class Nfe_model extends CI_Model
{
    ...
    public function buscarTributacao($venda_id)
    {
        ...
        $this->db->select('vendas.*, clientes.*, operacao_comercial.nome as operacao_comercial, 
        ...
        $this->db->join('operacao_comercial', 'operacao_comercial.id = vendas.operacao_comercial_id');
        $this->db->join('classificacao_fiscal', 'classificacao_fiscal.operacao_comercial_id = operacao_comercial.id');
