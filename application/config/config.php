 ...
 * Nome do sistema
 */
$config['app_name'] = $_ENV['APP_NAME'] ?? 'AgilizePro';
...
|
*/
// Detectar dinamicamente a URL base para permitir acesso externo
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http';
$host = $_SERVER['HTTP_HOST'] ?? 'localhost';
$base_path = dirname($_SERVER['SCRIPT_NAME'] ?? '/');
$base_path = $base_path === '/' ? '' : $base_path;

$config['base_url'] = $_ENV['APP_BASEURL'] ?? $protocol . '://' . $host . $base_path . '/';
...
// Detectar dinamicamente o domínio do cookie para acesso externo
$config['cookie_domain'] = $_ENV['APP_COOKIE_DOMAIN'] ?? (isset($_SERVER['HTTP_HOST']) ? '.' . $_SERVER['HTTP_HOST'] : '');
