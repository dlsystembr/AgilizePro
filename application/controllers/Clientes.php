    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'inscricao' => set_value('inscricao'),
                'natureza_contribuinte' => set_value('natureza_contribuinte'),
    ...
    public function editar($id = null)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->clientes_model->edit('clientes', $data, 'idClientes', $id) == true) {
                ...
                log_info('Alterou um cliente. ID' . $id);
                redirect(site_url('clientes/editar/') . $id);
            } else {
                $this->data['custom_error'] = '<div class="form_error"><p>Ocorreu um erro</p></div>';
            }
        }
