                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divEditarVenda">
                                <form action="<?php echo base_url(); ?>index.php/vendas/atualizar" method="post" id="formVendas">
                                        ...
                                        <div class="span3">
                                            ...
                                            <select name="operacao_comercial_id" id="operacao_comercial" class="span12" required>
                                                ...
                                                <?php foreach ($operacoes as $o) { ?>
                                                    <option value="<?php echo $o->id; ?>" <?php echo ($o->id == $result->operacao_comercial_id) ? 'selected' : ''; ?>><?php echo $o->nome_operacao; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="span3">
