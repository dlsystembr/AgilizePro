                                    ...
                                    <div class="control-group" style="margin-bottom: 0;">
                                        ...
                                        <div class="controls">
                                            <input id="EMP_CODIGO" type="text" name="EMP_CODIGO"
                                                value="<?php echo $result->EMP_CODIGO ?? ''; ?>"
                                    ...
                                    <div class="control-group" style="margin-bottom: 0;">
                                        ...
                                        <div class="controls">
                                            <select id="EMP_SITUACAO" name="EMP_SITUACAO">
                                                <option value="1" <?php echo (isset($result->EMP_SITUACAO) && $result->EMP_SITUACAO == 1) ? 'selected' : ''; ?>>Ativo</option>
                                                <option value="0" <?php echo (isset($result->EMP_SITUACAO) && $result->EMP_SITUACAO == 0) ? 'selected' : ''; ?>>Inativo</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
