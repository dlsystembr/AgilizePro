            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                        ...
                        <div class="controls">
                            <select name="tributacao_produto_id" id="tributacao_produto_id">
                                ...
                                <?php foreach ($tributacoes as $t): ?>
                                    <option value="<?= $t->id ?>" <?= set_value('tributacao_produto_id') == $t->id ? 'selected' : '' ?>><?= $t->nome_configuracao ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="NCMs" type="text" name="NCMs" value="<?php echo set_value('NCMs'); ?>" maxlength="8" placeholder="Código NCM do produto" />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="origem" name="origem">
                                ...
                                <option value="3">3 - Nacional – Conteúdo de importação superior a 40% e inferior ou igual a 70%</option>
                                <option value="4">4 - Nacional – Produzido conforme os processos produtivos básicos (PPB)</option>
                                <option value="5">5 - Nacional – Conteúdo de importação inferior ou igual a 40%</option>
                                <option value="6">6 - Estrangeira – Importação direta sem similar nacional, constante da CAMEX</option>
