        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="NCMs" class="control-label">NCM</label>
                        <div class="controls">
                            <input id="NCMs" type="text" name="NCMs" value="<?php echo $result->NCMs; ?>" maxlength="8" placeholder="Código NCM do produto" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="origem" name="origem">
                                <option value="0" <?php if (!isset($result->origem) || $result->origem == 0) echo 'selected'; ?>>0 - Nacional (exceto as indicadas nos códigos 3, 4, 5 e 8)</option>
                                <option value="1" <?php if (isset($result->origem) && $result->origem == 1) echo 'selected'; ?>>1 - Estrangeira – Importação direta</option>
                                <option value="2" <?php if (isset($result->origem) && $result->origem == 2) echo 'selected'; ?>>2 - Estrangeira – Adquirida no mercado interno</option>
                                <option value="3" <?php if (isset($result->origem) && $result->origem == 3) echo 'selected'; ?>>3 - Nacional – Conteúdo de importação superior a 40% e inferior ou igual a 70%</option>
                                <option value="4" <?php if (isset($result->origem) && $result->origem == 4) echo 'selected'; ?>>4 - Nacional – Produzido conforme os processos produtivos básicos (PPB)</option>
                                <option value="5" <?php if (isset($result->origem) && $result->origem == 5) echo 'selected'; ?>>5 - Nacional – Conteúdo de importação inferior ou igual a 40%</option>
                                <option value="6" <?php if (isset($result->origem) && $result->origem == 6) echo 'selected'; ?>>6 - Estrangeira – Importação direta sem similar nacional, constante da CAMEX</option>
                                <option value="7" <?php if (isset($result->origem) && $result->origem == 7) echo 'selected'; ?>>7 - Estrangeira – Adquirida no mercado interno, sem similar nacional</option>
                                <option value="8" <?php if (isset($result->origem) && $result->origem == 8) echo 'selected'; ?>>8 - Nacional – Conteúdo de importação superior a 70%</option>
                            </select>
