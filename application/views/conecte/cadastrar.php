...
<body>
    ...
    <div class="row-fluid">
        <div id="footer" class="span12" style="padding: 10px">
            <a class="pecolor" href="https://dlsystem.com.br"dlsystem.com.br target="_blank">
                <?= date('Y') ?> &copy; DL System Tecnologia - <?= $this->config->item('app_name') ?> - Versão: <?= $this->config->item('app_version'); ?>
            </a>
        </div>
    </div>
