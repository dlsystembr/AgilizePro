<style>
    ...
    .form-section input#emp_codigo_readonly { width: 150px; max-width: 150px; }
</style>

<div class="new122">
  <div class="widget-title" style="margin: -20px 0 0">
    <span class="icon"><i class="bx bx-edit"></i></span>
    <h5>Editar Empresa - Grupo: <?= htmlspecialchars($grupo->gre_nome) ?></h5>
  </div>
  <?php if (isset($custom_error) && $custom_error): ?>
    <div class="alert alert-danger"><?= $custom_error ?></div>
  <?php endif; ?>
  <form action="<?= base_url("index.php/super/editarEmpresa/{$grupo->gre_id}/{$result->emp_id}") ?>" id="formEmpresa" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  <label for="emp_codigo_readonly" class="control-label">Código</label>
                  <div class="controls">
                    <input id="emp_codigo_readonly" type="text" value="<?= htmlspecialchars($result->EMP_CODIGO ?? $result->emp_id ?? '') ?>" readonly style="width: 150px;" />
                  </div>
                </div>
              </div>
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <select id="emp_ativo" name="emp_ativo">
                      <option value="1" <?= (isset($result->emp_ativo) && $result->emp_ativo == 1) || (isset($result->EMP_SITUACAO) && $result->EMP_SITUACAO == 1) ? 'selected' : '' ?>>Ativo</option>
                      <option value="0" <?= (isset($result->emp_ativo) && $result->emp_ativo == 0) || (isset($result->EMP_SITUACAO) && $result->EMP_SITUACAO == 0) ? 'selected' : '' ?>>Inativo</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div class="span12">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls" style="display: flex; align-items: center; gap: 8px;">
                    <input id="emp_cnpj" type="text" name="emp_cnpj" value="<?= htmlspecialchars($result->emp_cnpj ?? '') ?>" inputmode="numeric" autocomplete="off" style="flex: 1; min-width: 0;" />
            ...
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span12">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_razao_social" type="text" name="emp_razao_social" value="<?= htmlspecialchars($result->emp_razao_social ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row-fluid">
              <div class="span12">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_nome_fantasia" type="text" name="emp_nome_fantasia" value="<?= htmlspecialchars($result->emp_nome_fantasia ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_cep" type="text" name="emp_cep" value="<?= htmlspecialchars($result->emp_cep ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span8">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_logradouro" type="text" name="emp_logradouro" value="<?= htmlspecialchars($result->emp_logradouro ?? '') ?>" />
                  </div>
                </div>
              </div>
              <div class="span4">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_numero" type="text" name="emp_numero" value="<?= htmlspecialchars($result->emp_numero ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span12">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_complemento" type="text" name="emp_complemento" value="<?= htmlspecialchars($result->emp_complemento ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span12">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_bairro" type="text" name="emp_bairro" value="<?= htmlspecialchars($result->emp_bairro ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row-fluid">
              <div class="span8">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_cidade" type="text" name="emp_cidade" value="<?= htmlspecialchars($result->emp_cidade ?? '') ?>" />
                  </div>
                </div>
              </div>
              <div class="span4">
                  ...
                  <div class="controls">
                    <select id="emp_uf" name="emp_uf">
                      ...
                      <?php if (!empty($estados)): foreach ($estados as $estado): ?>
                        <option value="<?= $estado->est_uf ?>" <?= (isset($result->emp_uf) && $result->emp_uf == $estado->est_uf) ? 'selected' : '' ?>><?= $estado->est_uf ?></option>
            ...
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_telefone" type="text" name="emp_telefone" value="<?= htmlspecialchars($result->emp_telefone ?? '') ?>" />
                  </div>
                </div>
              </div>
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_email" type="email" name="emp_email" value="<?= htmlspecialchars($result->emp_email ?? '') ?>" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row-fluid" style="margin-bottom: 15px;">
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <input id="emp_ie" type="text" name="emp_ie" value="<?= htmlspecialchars($result->emp_ie ?? '') ?>" />
                  </div>
                </div>
              </div>
              <div class="span6">
                <div class="control-group" style="margin-bottom: 0;">
                  ...
                  <div class="controls">
                    <select id="emp_regime_tributario" name="emp_regime_tributario">
                      <option value="">Selecione</option>
                      <option value="Simples Nacional" <?= (isset($result->emp_regime_tributario) && $result->emp_regime_tributario == 'Simples Nacional') ? 'selected' : '' ?>>Simples Nacional</option>
                      <option value="Lucro Presumido" <?= (isset($result->emp_regime_tributario) && $result->emp_regime_tributario == 'Lucro Presumido') ? 'selected' : '' ?>>Lucro Presumido</option>
                      <option value="Lucro Real" <?= (isset($result->emp_regime_tributario) && $result->emp_regime_tributario == 'Lucro Real') ? 'selected' : '' ?>>Lucro Real</option>
                    </select>
                  </div>
                </div>
              </div>
                  ...
                  <div class="controls">
                    <?php if (!empty($result->emp_logo_path) && file_exists(FCPATH . $result->emp_logo_path)): ?>
                      <div style="margin-bottom: 10px;">
                        <img src="<?= base_url($result->emp_logo_path) ?>" alt="Logo atual" style="max-width: 200px; max-height: 100px; border: 1px solid #ddd; padding: 5px;">
                    ...
                    <input type="hidden" name="EMP_LOGO_PATH_ATUAL" value="<?= htmlspecialchars($result->emp_logo_path ?? '') ?>">
                  </div>
                </div>
              </div>
            </div>
