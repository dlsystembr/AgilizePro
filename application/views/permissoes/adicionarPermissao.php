               ...
               <i class="fas fa-lock"></i>
                ...
                <div class="widget-content">
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input name="rNfe" class="marcar" type="checkbox" value="1" />
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vNfe" class="marcar" type="checkbox" checked="checked" value="1" />
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vTributacao" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar Tributações</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="vTributacaoProduto" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar Tributação Produto</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Tributação Produto</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="dTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vClassificacaoFiscal" class="marcar" type="checkbox" value="1" checked />
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vNcm" class="marcar" type="checkbox" checked="checked" value="1" />
                    ...
                    <div class="accordion-group widget-box">
                        <div class="accordion-heading">
                            <div class="widget-title">
                                <a data-parent="#collapse-group" href="#collapseGNfecomAdd" data-toggle="collapse">
                                    <span><i class='bx bx-file-invoice icon-cli'></i></span>
                        ...
                        <div class="collapse accordion-body" id="collapseGNfecomAdd">
                            <div class="widget-content">
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vNfecom" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Visualizar NFECom</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aNfecom" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar NFECom</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eNfecom" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar NFECom</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dNfecom" class="marcar" type="checkbox" value="1" />
