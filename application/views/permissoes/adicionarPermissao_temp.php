...
// A variável vem do controller via $this->data['permissoes_habilitadas']
                                ...
                                <div id="tab1" class="tab-pane active" style="min-height: 300px">
                                    <div class="accordion" id="collapse-group">
                                        ...
                                        <?php if (permissao_habilitada('vProduto', $permissoes_habilitadas, $ten_id) || 
                                                  permissao_habilitada('aProduto', $permissoes_habilitadas, $ten_id) || 
                                                  permissao_habilitada('eProduto', $permissoes_habilitadas, $ten_id) || 
                                                  permissao_habilitada('dProduto', $permissoes_habilitadas, $ten_id)): ?>
                                        <div class="accordion-group widget-box">
                                            <div class="accordion-heading">
                                                <div class="widget-title">
                                                ...
                                                <div class="widget-content">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['vPessoa'])) {
                                                                        if ($permissoes['vPessoa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="vPessoa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['aPessoa'])) {
                                                                        if ($permissoes['aPessoa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="aPessoa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['ePessoa'])) {
                                                                        if ($permissoes['ePessoa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="ePessoa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['dPessoa'])) {
                                                                        if ($permissoes['dPessoa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="dPessoa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                ...
                                                <div class="widget-content">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['vContrato'])) {
                                                                        if ($permissoes['vContrato'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="vContrato" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['aContrato'])) {
                                                                        if ($permissoes['aContrato'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="aContrato" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['eContrato'])) {
                                                                        if ($permissoes['eContrato'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="eContrato" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['dContrato'])) {
                                                                        if ($permissoes['dContrato'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="dContrato" class="marcar"
                                                                        type="checkbox" value="1" />
                                                ...
                                                <div class="widget-content">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['vEmpresa'])) {
                                                                        if ($permissoes['vEmpresa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="vEmpresa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['aEmpresa'])) {
                                                                        if ($permissoes['aEmpresa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="aEmpresa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['eEmpresa'])) {
                                                                        if ($permissoes['eEmpresa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="eEmpresa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input <?php if (isset($permissoes['dEmpresa'])) {
                                                                        if ($permissoes['dEmpresa'] == '1') {
                                                                            echo 'checked';
                                                                        }
                                                                    } ?> name="dEmpresa" class="marcar"
                                                                        type="checkbox" value="1" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label>
                                                                    ...
                                                                    } ?> name="rNfe" class="marcar" type="checkbox"
                                                                        value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input name="vNfe" class="marcar"
                                                                            type="checkbox" value="1" <?php echo (isset($permissoes['vNfe']) && $permissoes['vNfe'] == 1) ? 'checked' : ''; ?> />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input name="eNfe" class="marcar"
                                                                            type="checkbox" value="1" <?php echo (isset($permissoes['eNfe']) && $permissoes['eNfe'] == 1) ? 'checked' : ''; ?> />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['vTributacaoProduto'])) {
                                                                            ...
                                                                            name="vTributacaoProduto" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['aTributacaoProduto'])) {
                                                                            ...
                                                                            name="aTributacaoProduto" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['eTributacaoProduto'])) {
                                                                            ...
                                                                            name="eTributacaoProduto" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['dTributacaoProduto'])) {
                                                                            ...
                                                                            name="dTributacaoProduto" class="marcar"
                                                                            type="checkbox" value="1" />
                                        ...
                                        <div class="accordion-group widget-box">
                                            <div class="accordion-heading">
                                                <div class="widget-title">
                                                    <a data-parent="#collapse-group" href="#collapseGOperacaoComercial"
                                                        data-toggle="collapse">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['vOperacaoComercial'])) {
                                                                            if ($permissoes['vOperacaoComercial'] == '1') {
                                                                                echo 'checked';
                                                                            }
                                                                        } ?>
                                                                            name="vOperacaoComercial" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Visualizar Operação
                                                                            Comercial</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['aOperacaoComercial'])) {
                                                                            if ($permissoes['aOperacaoComercial'] == '1') {
                                                                                echo 'checked';
                                                                            }
                                                                        } ?>
                                                                            name="aOperacaoComercial" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Adicionar Operação
                                                                            Comercial</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['eOperacaoComercial'])) {
                                                                            if ($permissoes['eOperacaoComercial'] == '1') {
                                                                                echo 'checked';
                                                                            }
                                                                        } ?>
                                                                            name="eOperacaoComercial" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Editar Operação
                                                                            Comercial</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['dOperacaoComercial'])) {
                                                                            if ($permissoes['dOperacaoComercial'] == '1') {
                                                                                echo 'checked';
                                                                            }
                                                                        } ?>
                                                                            name="dOperacaoComercial" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Excluir Operação
                                                                            Comercial</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                            ...
                                            <div class="accordion-heading">
                                                <div class="widget-title">
                                                    <a data-parent="#collapse-group"
                                                        href="#collapseGClassificacaoFiscal" data-toggle="collapse">
                                                        <span><i class='bx bx-receipt icon-cli'></i></span>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['vClassificacaoFiscal'])) {
                                                                            ...
                                                                            name="vClassificacaoFiscal" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Visualizar Classificação
                                                                            Fiscal</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['aClassificacaoFiscal'])) {
                                                                            ...
                                                                            name="aClassificacaoFiscal" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Adicionar Classificação
                                                                            Fiscal</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['eClassificacaoFiscal'])) {
                                                                            ...
                                                                            name="eClassificacaoFiscal" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Editar Classificação
                                                                            Fiscal</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['dClassificacaoFiscal'])) {
                                                                            ...
                                                                            name="dClassificacaoFiscal" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Excluir Classificação
                                                                            Fiscal</span>
                                                                    </label>
                                                                </td>
                                                                <?php endif; ?>
                                        ...
                                        <div class="accordion-group widget-box">
                                            <div class="accordion-heading">
                                                <div class="widget-title">
                                                    <a data-parent="#collapse-group" href="#collapseGAliquotas"
                                                        data-toggle="collapse">
                                        ...
                                        <div class="accordion-group widget-box">
                                            <div class="accordion-heading">
                                                <div class="widget-title">
                                                    <a data-parent="#collapse-group" href="#collapseGFaturamentoEntrada"
                                                        data-toggle="collapse">
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['vFaturamentoEntrada'])) {
                                                                            ...
                                                                            name="vFaturamentoEntrada" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['aFaturamentoEntrada'])) {
                                                                            ...
                                                                            name="aFaturamentoEntrada" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['eFaturamentoEntrada'])) {
                                                                            ...
                                                                            name="eFaturamentoEntrada" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                ...
                                                                <td>
                                                                    <label>
                                                                        <input <?php if (isset($permissoes['dFaturamentoEntrada'])) {
                                                                            ...
                                                                            name="dFaturamentoEntrada" class="marcar"
                                                                            type="checkbox" value="1" />
                                                                        <span class="lbl"> Excluir Faturamento de
                                                                            Entrada</span>
                                                                    </label>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <label>
                                                                    ...
                                                                    } ?> name="vNcm" class="marcar" type="checkbox"
                                                                        value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    ...
                                                                    } ?> name="aNcm" class="marcar" type="checkbox"
                                                                        value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    ...
                                                                    } ?> name="eNcm" class="marcar" type="checkbox"
                                                                        value="1" />
                                                            ...
                                                            <td>
                                                                <label>
                                                                    ...
                                                                    } ?> name="dNcm" class="marcar" type="checkbox"
                                                                        value="1" />
