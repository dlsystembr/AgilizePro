        ...
        <div id="tab1" class="tab-pane active" style="min-height: 300px">
            <div class="accordion" id="collapse-group">
                ...
                <div class="accordion-group widget-box">
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGPessoas" data-toggle="collapse">
                                <span><i class='bx bx-group icon-cli' ></i></span>
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vPessoa'])) { if ($permissoes['vPessoa'] == '1') { echo 'checked'; } }?> name="vPessoa" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Pessoa</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aPessoa'])) { if ($permissoes['aPessoa'] == '1') { echo 'checked'; } }?> name="aPessoa" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Pessoa</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['ePessoa'])) { if ($permissoes['ePessoa'] == '1') { echo 'checked'; } }?> name="ePessoa" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Pessoa</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dPessoa'])) { if ($permissoes['dPessoa'] == '1') { echo 'checked'; } }?> name="dPessoa" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            }?> name="rNfe" class="marcar" type="checkbox" value="1" />
                ...
                <div class="accordion-group widget-box">
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGNfe" data-toggle="collapse">
                              <span><i class='bx bx-receipt icon-cli'></i></span>
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input name="vNfe" class="marcar" type="checkbox" value="1" <?php echo (isset($permissoes['vNfe']) && $permissoes['vNfe'] == 1) ? 'checked' : ''; ?> />
                                            <span class="lbl"> Visualizar Emissor de Notas</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input name="eNfe" class="marcar" type="checkbox" value="1" <?php echo (isset($permissoes['eNfe']) && $permissoes['eNfe'] == 1) ? 'checked' : ''; ?> />
                                            <span class="lbl"> Editar Emissor de Notas</span>
                                        </label>
                                    </td>
                                </tr>
                                </tbody>
                ...
                <div class="accordion-group widget-box">
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGTrib" data-toggle="collapse">
                              <span><i class='bx bx-receipt icon-cli'></i></span>
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vTributacao'])) {
                                                if ($permissoes['vTributacao'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vTributacao" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Tributações</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vTributacaoProduto'])) {
                                                if ($permissoes['vTributacaoProduto'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Tributação Produto</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aTributacaoProduto'])) {
                                                if ($permissoes['aTributacaoProduto'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="aTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Tributação Produto</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eTributacaoProduto'])) {
                                                if ($permissoes['eTributacaoProduto'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="eTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Tributação Produto</span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dTributacaoProduto'])) {
                                                if ($permissoes['dTributacaoProduto'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="dTributacaoProduto" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Tributação Produto</span>
                                        </label>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vOperacaoComercial'])) { if ($permissoes['vOperacaoComercial'] == '1') { echo 'checked'; } }?> name="vOperacaoComercial" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Operação Comercial</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aOperacaoComercial'])) { if ($permissoes['aOperacaoComercial'] == '1') { echo 'checked'; } }?> name="aOperacaoComercial" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Operação Comercial</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eOperacaoComercial'])) { if ($permissoes['eOperacaoComercial'] == '1') { echo 'checked'; } }?> name="eOperacaoComercial" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Operação Comercial</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dOperacaoComercial'])) { if ($permissoes['dOperacaoComercial'] == '1') { echo 'checked'; } }?> name="dOperacaoComercial" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vClassificacaoFiscal'])) {
                                                if ($permissoes['vClassificacaoFiscal'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vClassificacaoFiscal" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Visualizar Classificação Fiscal</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aClassificacaoFiscal'])) {
                                                if ($permissoes['aClassificacaoFiscal'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="aClassificacaoFiscal" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Classificação Fiscal</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eClassificacaoFiscal'])) {
                                                if ($permissoes['eClassificacaoFiscal'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="eClassificacaoFiscal" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar Classificação Fiscal</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dClassificacaoFiscal'])) {
                                                if ($permissoes['dClassificacaoFiscal'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="dClassificacaoFiscal" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vAliquota'])) {
                                                if ($permissoes['vAliquota'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vAliquota" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Alíquota</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aAliquota'])) {
                                                if ($permissoes['aAliquota'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="aAliquota" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vFaturamentoEntrada'])) {
                                                if ($permissoes['vFaturamentoEntrada'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vFaturamentoEntrada" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Visualizar Faturamento de Entrada</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aFaturamentoEntrada'])) {
                                                if ($permissoes['aFaturamentoEntrada'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="aFaturamentoEntrada" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Faturamento de Entrada</span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eFaturamentoEntrada'])) {
                                                if ($permissoes['eFaturamentoEntrada'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="eFaturamentoEntrada" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar Faturamento de Entrada</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dFaturamentoEntrada'])) {
                                                if ($permissoes['dFaturamentoEntrada'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="dFaturamentoEntrada" class="marcar" type="checkbox" value="1" />
                ...
                <div class="accordion-group widget-box">
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGNcm" data-toggle="collapse">
                                <span><i class='bx bx-package icon-cli'></i></span>
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vNcm'])) {
                                                if ($permissoes['vNcm'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vNcm" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar NCMs</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aNcm'])) {
                                                if ($permissoes['aNcm'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="aNcm" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar NCMs</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eNcm'])) {
                                                if ($permissoes['eNcm'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="eNcm" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar NCMs</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dNcm'])) {
                                                if ($permissoes['dNcm'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="dNcm" class="marcar" type="checkbox" value="1" />
                ...
                <div class="accordion-group widget-box">
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGNfecom" data-toggle="collapse">
                                <span><i class='bx bx-file-invoice icon-cli'></i></span>
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vNfecom'])) {
                                                if ($permissoes['vNfecom'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="vNfecom" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar NFECom</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aNfecom'])) {
                                                if ($permissoes['aNfecom'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="aNfecom" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar NFECom</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eNfecom'])) {
                                                if ($permissoes['eNfecom'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="eNfecom" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar NFECom</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dNfecom'])) {
                                                if ($permissoes['dNfecom'] == '1') {
                                                    echo 'checked';
                                                }
                                            }?> name="dNfecom" class="marcar" type="checkbox" value="1" />
