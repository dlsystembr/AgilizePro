...
<div class="form-group">
    <label class="col-sm-2 control-label">Classificação Fiscal</label>
    <div class="col-sm-10">
        <div class="checkbox">
            <label>
                <input type="checkbox" name="aClassificacaoFiscal" value="1" <?php if (isset($permissao) && $permissao->aClassificacaoFiscal == 1) {
                    echo 'checked';
                } ?>> Adicionar
            </label>
            <label>
                <input type="checkbox" name="eClassificacaoFiscal" value="1" <?php if (isset($permissao) && $permissao->eClassificacaoFiscal == 1) {
                    echo 'checked';
                } ?>> Editar
            </label>
            <label>
                <input type="checkbox" name="dClassificacaoFiscal" value="1" <?php if (isset($permissao) && $permissao->dClassificacaoFiscal == 1) {
                    echo 'checked';
                } ?>> Excluir
            </label>
            <label>
                <input type="checkbox" name="vClassificacaoFiscal" value="1" <?php if (isset($permissao) && $permissao->vClassificacaoFiscal == 1) {
                    echo 'checked';
                } ?>> Visualizar
            </label>
        </div>
