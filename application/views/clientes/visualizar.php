                    ...
                    <div class="collapse in accordion-body" id="collapseGOne">
                        <div class="widget-content">
                            <table class="table table-bordered" style="border: 1px solid #ddd">
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Natureza do Contribuinte</strong></td>
                                    <td>
                                        <?php echo $result->natureza_contribuinte == 'inscrito' ? 'Inscrito' : ($result->natureza_contribuinte == 'nao_inscrito' ? 'Não Inscrito' : 'Não Informado') ?>
                                    </td>
                                </tr>
                                <tr>
