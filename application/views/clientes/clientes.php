            ...
            <table id="tabela" class="table table-bordered ">
                ...
                <tbody>
                    ...
                    foreach ($results as $r) {
                        ...
                        echo '<td>' . ($r->natureza_contribuinte === 'inscrito' ? 'Inscrito' : ($r->natureza_contribuinte === 'nao_inscrito' ? 'Não Inscrito' : 'Não Informado')) . '</td>';
                        ...
                        } else if ($r->fornecedor == 3) {
                            echo '<td><span class="label label-info">Transportadora</span></td>';
                        } else {
