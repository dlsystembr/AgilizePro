            ...
            <div class="row-fluid">
                <div class="span8">
                    <h3 style="margin: 0; color: #333;">
                        <i class="fas fa-file-invoice"></i> NFCom <?php echo $result->NFC_NNF; ?>
                    </h3>
                    <p style="margin: 5px 0 0 0; color: #666;">
                        Série: <?php echo $result->NFC_SERIE; ?> | Chave: <?php echo $result->NFC_CH_NFCOM; ?>
                    </p>
                </div>
                <div class="span4" style="text-align: right;">
                    <div class="nfecom-status-badge" style="background-color:
                        <?php
                        echo match((int)$result->NFC_STATUS) {
                            0 => '#CDB380',
                            1 => '#436eee',
                            2 => '#00cd00',
                            3 => '#4d9c79',
                        ...
                        echo match((int)$result->NFC_STATUS) {
                            ...
                            5 => 'Autorizada',
                            7 => 'Cancelada',
                            default => 'Desconhecido (Status: ' . $result->NFC_STATUS . ')'
                        };
                        ?>
                    </div>
                    ...
                    <div style="font-size: 12px; opacity: 0.9;">
                        ...
                        <?php if (strlen($result->NFC_X_MOTIVO) > 60) echo '...'; ?>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content tab-content">
                ...
                <div class="tab-pane active" id="dados-gerais">
                    <div class="nfecom-card <?php echo ($result->NFC_STATUS == 4 && $this->permission->checkPermission($this->session->userdata('permissao'), 'eNfecom')) ? 'edit-mode' : ''; ?>">
                        <div class="nfecom-card-header">
                            <h4><i class="fas fa-info-circle"></i> Dados Gerais da NFCom</h4>
                        </div>
                        <div class="nfecom-card-body">
                            <form id="editForm" method="post" action="<?php echo base_url(); ?>index.php/nfecom/editar/<?php echo $result->NFC_ID; ?>">
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="control-group">
                                            <label class="control-label">Número NF:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_NNF; ?></span>
                                                <input type="text" name="nfc_nnf" class="span12 edit-field" value="<?php echo $result->NFC_NNF; ?>" style="display: none;" readonly>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Série:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_SERIE; ?></span>
                                                <input type="text" name="nfc_serie" class="span12 edit-field" value="<?php echo $result->NFC_SERIE; ?>" style="display: none;">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_N_CONTRATO; ?></span>
                                                <input type="text" name="nfc_n_contrato" class="span12 edit-field" value="<?php echo $result->NFC_N_CONTRATO; ?>" style="display: none;">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Data Início Contrato:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo date('d/m/Y', strtotime($result->NFC_D_CONTRATO_INI)); ?></span>
                                                <input type="date" name="nfc_d_contrato_ini" class="span12 edit-field" value="<?php echo date('Y-m-d', strtotime($result->NFC_D_CONTRATO_INI)); ?>" style="display: none;">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                ...
                                <div class="edit-actions" style="display: none; margin-top: 20px; padding-top: 20px; border-top: 1px solid #e1e8ed;">
                                    <div class="span6">
                    ...
                    <div class="nfecom-card <?php echo ($result->NFC_STATUS == 4 && $this->permission->checkPermission($this->session->userdata('permissao'), 'eNfecom')) ? 'edit-mode' : ''; ?>">
                        <div class="nfecom-card-header">
                            ...
                            <div style="float: right;">
                                <button type="button" class="btn btn-edit-modern" onclick="toggleEditMode()" title="Editar NFCom">
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_X_NOME_EMIT; ?></span>
                                                <input type="text" name="nfc_x_nome_emit" class="span12 edit-field" value="<?php echo $result->NFC_X_NOME_EMIT; ?>" style="display: none;" readonly>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">CNPJ:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_CNPJ_EMIT; ?></span>
                                                <input type="text" name="nfc_cnpj_emit" class="span12 edit-field" value="<?php echo $result->NFC_CNPJ_EMIT; ?>" style="display: none;" readonly>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Inscrição Estadual:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_IE_EMIT; ?></span>
                                                <input type="text" name="nfc_ie_emit" class="span12 edit-field" value="<?php echo $result->NFC_IE_EMIT; ?>" style="display: none;" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span6">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Nome:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_X_NOME_DEST; ?></span>
                                                <input type="text" name="nfc_x_nome_dest" class="span12 edit-field" value="<?php echo $result->NFC_X_NOME_DEST; ?>" style="display: none;">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">CNPJ:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_CNPJ_DEST; ?></span>
                                                <input type="text" name="nfc_cnpj_dest" class="span12 edit-field" value="<?php echo $result->NFC_CNPJ_DEST; ?>" style="display: none;">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Endereço:</label>
                                            <div class="controls">
                                                <span class="view-mode"><?php echo $result->NFC_X_LGR_DEST . ', ' . $result->NFC_NRO_DEST; ?><br>
                                                <?php echo $result->NFC_X_BAIRRO_DEST . ', ' . $result->NFC_X_MUN_DEST . '/' . $result->NFC_UF_DEST; ?><br>
                                                CEP: <?php echo $result->NFC_CEP_DEST; ?></span>
                                                <div class="edit-field" style="display: none;">
                                                    <input type="text" name="nfc_x_lgr_dest" class="span12" value="<?php echo $result->NFC_X_LGR_DEST; ?>" placeholder="Logradouro" style="margin-bottom: 5px;">
                                                    <input type="text" name="nfc_nro_dest" class="span4" value="<?php echo $result->NFC_NRO_DEST; ?>" placeholder="Nº" style="margin-bottom: 5px;">
                                                    <input type="text" name="nfc_x_bairro_dest" class="span8" value="<?php echo $result->NFC_X_BAIRRO_DEST; ?>" placeholder="Bairro" style="margin-bottom: 5px;">
                                                    <input type="text" name="nfc_x_mun_dest" class="span8" value="<?php echo $result->NFC_X_MUN_DEST; ?>" placeholder="Cidade" style="margin-bottom: 5px;">
                                                    <input type="text" name="nfc_uf_dest" class="span2" value="<?php echo $result->NFC_UF_DEST; ?>" placeholder="UF" maxlength="2" style="margin-bottom: 5px;">
                                                    <input type="text" name="nfc_cep_dest" class="span4" value="<?php echo $result->NFC_CEP_DEST; ?>" placeholder="CEP">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form id="editForm" method="post" action="<?php echo base_url(); ?>index.php/nfecom/editar/<?php echo $result->NFC_ID; ?>">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo number_format($item->NFI_Q_FATURADA, 4, ',', '.'); ?></td>
                                                    <td style="text-align: right;">R$ <?php echo number_format($item->NFI_V_ITEM, 2, ',', '.'); ?></td>
                                                    <td style="text-align: right;"><strong>R$ <?php echo number_format($item->NFI_V_PROD, 2, ',', '.'); ?></strong></td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                ...
                                <div class="edit-field" style="display: none;">
                                    <div id="itens-container">
                                        <?php $itemCount = 0; ?>
                                        <?php foreach ($itens as $item): $itemCount++; ?>
                                        <div class="item-row" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 15px; border-radius: 5px; background: #f9f9f9;">
                                            <div class="row-fluid">
                                                <div class="span1">
                                                    <label>Item:</label>
                                                    <input type="text" name="itens[<?php echo $itemCount; ?>][n_item]" value="<?php echo $item->NFI_N_ITEM; ?>" class="span12" readonly>
                                                </div>
                                                <div class="span2">
                                                    <label>Código:</label>
                                                    <input type="text" name="itens[<?php echo $itemCount; ?>][c_prod]" value="<?php echo $item->NFI_C_PROD; ?>" class="span12">
                                                </div>
                                                <div class="span3">
                                                    <label>Descrição:</label>
                                                    <input type="text" name="itens[<?php echo $itemCount; ?>][x_prod]" value="<?php echo $item->NFI_X_PROD; ?>" class="span12">
                                                </div>
                                                <div class="span1">
                                                    <label>CFOP:</label>
                                                    <input type="text" name="itens[<?php echo $itemCount; ?>][cfop]" value="<?php echo $item->NFI_CFOP; ?>" class="span12">
                                                </div>
                                                <div class="span2">
                                                    <label>Quantidade:</label>
                                                    <input type="text" name="itens[<?php echo $itemCount; ?>][q_faturada]" value="<?php echo number_format($item->NFI_Q_FATURADA, 4, ',', '.'); ?>" class="span12">
                                                </div>
                                                <div class="span2">
                                                    <label>Valor Unitário:</label>
                                                    <input type="text" name="itens[<?php echo $itemCount; ?>][v_item]" value="<?php echo number_format($item->NFI_V_ITEM, 2, ',', '.'); ?>" class="span12">
                                                </div>
                                                <div class="span1">
                                        ...
                                        <div class="view-mode">
                                            <table class="table table-striped">
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;">R$ <?php echo number_format($result->NFC_V_PROD, 2, ',', '.'); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>PIS:</strong></td>
                                                    <td style="text-align: right;">R$ <?php echo number_format($result->NFC_V_PIS, 2, ',', '.'); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>COFINS:</strong></td>
                                                    <td style="text-align: right;">R$ <?php echo number_format($result->NFC_V_COFINS, 2, ',', '.'); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>IRRF:</strong></td>
                                                    <td style="text-align: right;">R$ <?php echo number_format($result->NFC_V_IRRF, 2, ',', '.'); ?></td>
                                                </tr>
                                                <tr style="background-color: #f8f9fa;">
                                                    <td><strong style="font-size: 16px;">Valor Total NF:</strong></td>
                                                    <td style="text-align: right;"><strong style="font-size: 16px; color: #28a745;">R$ <?php echo number_format($result->NFC_V_NF, 2, ',', '.'); ?></strong></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    <div class="span6">
                                        ...
                                        <div class="view-mode">
                                            <table class="table table-striped">
                                                ...
                                                <tr style="background-color: #d4edda;">
                                                    ...
                                                    <td><span style="color: #155724; font-weight: bold;"><?php echo $result->NFC_N_PROT; ?></span></td>
                                                </tr>
                                                <tr style="background-color: #d4edda;">
                                                ...
                                                <tr style="<?php echo ($result->NFC_STATUS == 4) ? 'background-color: #f8d7da;' : 'background-color: #d4edda;'; ?>">
                                                    <td><strong>Código SEFAZ:</strong></td>
                                                    <td><?php echo $result->NFC_C_STAT; ?></td>
                                                </tr>
                                                <?php endif; ?>
                                            </table>
                                        </div>
                                        ...
                                        <div class="edit-field" style="display: none;">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" name="nfc_d_per_uso_ini" class="span12" value="<?php echo date('Y-m-d', strtotime($result->NFC_D_PER_USO_INI)); ?>">
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">Período Uso - Fim:</label>
                                                <div class="controls">
                                                    <input type="date" name="nfc_d_per_uso_fim" class="span12" value="<?php echo date('Y-m-d', strtotime($result->NFC_D_PER_USO_FIM)); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form id="editForm" method="post" action="<?php echo base_url(); ?>index.php/nfecom/editar/<?php echo $result->NFC_ID; ?>">
                                ...
                                <div class="edit-field" style="display: none;">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="nfc_inf_cpl" class="span12" rows="6" placeholder="Digite aqui as informações complementares da NFCom..."><?php echo $result->NFC_INF_CPL; ?></textarea>
                                            <small class="help-block">Informações adicionais sobre a nota fiscal (observações, referências, etc.)</small>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vNfecom')) { ?>
                            <a href="<?php echo base_url() ?>index.php/nfecom/danfe/<?php echo $result->NFC_ID; ?>" class="btn btn-inverse" target="_blank">
                        ...
                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eNfecom')): ?>
                            <?php if ($result->NFC_STATUS >= 3): ?>
                                <a href="<?php echo base_url() ?>index.php/nfecom/gerarXml/<?php echo $result->NFC_ID; ?>" class="btn btn-info" target="_blank">
                            ...
                            <?php if ($result->NFC_STATUS == 4): ?>
                                <!-- Botões de Edição -->
                                <button type="submit" form="editForm" class="btn btn-success btn-edit" style="margin-left: 10px;">
                                    <i class="fas fa-save"></i> Salvar Alterações
                                </button>
                                <button type="button" onclick="reenviarNota()" class="btn btn-primary btn-edit" style="margin-left: 5px;">
