                    ...
                    <div class="form-section" style="margin: 20px 0 0 0;">
                        ...
                        <div class="form-section-content">
                            ...
                            <div class="control-group" id="cst_group"
                                ...
                                <div class="controls">
                                    <select name="cst" id="cst" class="span12">
                                        ...
                                        <option value="30" <?= set_value('cst', $prefill['cst'] ?? '') == '30' ? 'selected' : '' ?>>30 - Isenta ou não tributada e com cobrança do ICMS por substituição tributária</option>
                                        ...
                                        <option value="70" <?= set_value('cst', $prefill['cst'] ?? '') == '70' ? 'selected' : '' ?>>70 - Com redução de base de cálculo e cobrança do ICMS por substituição tributária</option>
                            ...
                            <div class="control-group" id="csosn_group"
                                ...
                                <div class="controls">
                                    <select name="csosn" id="csosn" class="span12">
                                        ...
                                        <option value="201" <?= set_value('csosn', $prefill['csosn'] ?? '') == '201' ? 'selected' : '' ?>>201 - Tributada pelo Simples Nacional com permissão de crédito e com cobrança do ICMS por substituição tributária</option>
                                        <option value="202" <?= set_value('csosn', $prefill['csosn'] ?? '') == '202' ? 'selected' : '' ?>>202 - Tributada pelo Simples Nacional sem permissão de crédito e com cobrança do ICMS por substituição tributária</option>
                                        <option value="203" <?= set_value('csosn', $prefill['csosn'] ?? '') == '203' ? 'selected' : '' ?>>203 - Isenção do ICMS no Simples Nacional para faixa de receita bruta e com cobrança do ICMS por substituição tributária</option>
                                        ...
                                        <option value="500" <?= set_value('csosn', $prefill['csosn'] ?? '') == '500' ? 'selected' : '' ?>>500 - ICMS cobrado anteriormente por substituição tributária (substituído) ou por antecipação</option>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="tipo_icms" id="tipo_icms" required class="span12">
                                        <option value="normal" <?= set_value('tipo_icms', $prefill['tipo_icms'] ?? 'normal') == 'normal' ? 'selected' : '' ?>>ICMS Normal</option>
                                        <option value="st" <?= set_value('tipo_icms', $prefill['tipo_icms'] ?? '') == 'st' ? 'selected' : '' ?>>Substituição Tributária (ST)</option>
                                        <option value="servico" <?= set_value('tipo_icms', $prefill['tipo_icms'] ?? '') == 'servico' || set_value('tipo_icms', $prefill['tipo_icms'] ?? '') == 'Serviço' ? 'selected' : '' ?>>Serviço</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="natureza_contribuinte" id="natureza_contribuinte" class="span12">
                                        <option value="">Selecione</option>
                                        <option value="Contribuinte" <?= set_value('natureza_contribuinte', $prefill['natureza_contribuinte'] ?? '') == 'Contribuinte' ? 'selected' : '' ?>>Contribuinte</option>
                                        <option value="Não Contribuinte" <?= set_value('natureza_contribuinte', $prefill['natureza_contribuinte'] ?? '') == 'Não Contribuinte' ? 'selected' : '' ?>>Não Contribuinte</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="cfop" type="text" name="cfop" class="span12"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="objetivo_comercial" id="objetivo_comercial" required class="span12">
                                        <option value="">Selecione</option>
                                        <option value="Consumo" <?= set_value('objetivo_comercial', $prefill['objetivo_comercial'] ?? '') == 'Consumo' ? 'selected' : '' ?>>Consumo</option>
                                        <option value="Revenda" <?= set_value('objetivo_comercial', $prefill['objetivo_comercial'] ?? '') == 'Revenda' ? 'selected' : '' ?>>Revenda</option>
                                        <option value="Industrialização" <?= set_value('objetivo_comercial', $prefill['objetivo_comercial'] ?? '') == 'Industrialização' ? 'selected' : '' ?>>Industrialização</option>
                                        <option value="Orgão Público" <?= set_value('objetivo_comercial', $prefill['objetivo_comercial'] ?? '') == 'Orgão Público' ? 'selected' : '' ?>>Orgão Público</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="cClassTrib" id="cClassTrib" class="span12"
                                        value="<?= set_value('cClassTrib', $prefill['cClassTrib'] ?? '') ?>"
