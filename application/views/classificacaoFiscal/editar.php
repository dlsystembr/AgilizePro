                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="natureza_contribuinte" id="natureza_contribuinte" required>
                                            <option value="Contribuinte" <?php echo $classificacao->natureza_contribuinte == 'Contribuinte' ? 'selected' : ''; ?>>Contribuinte</option>
                                            <option value="Não Contribuinte" <?php echo $classificacao->natureza_contribuinte == 'Não Contribuinte' ? 'selected' : ''; ?>>Não Contribuinte</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
