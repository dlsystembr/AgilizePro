    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?= site_url('classificacaofiscal/editar/' . $result->id) ?>" id="formClassificacaoFiscal" method="post" class="form-horizontal">
                        ...
                        <div class="controls">
                            <select name="operacao_comercial_id" id="operacao_comercial_id">
                                ...
                                <?php foreach ($operacoes as $o) { ?>
                                    <option value="<?= $o->id ?>" <?= (set_value('operacao_comercial_id', $result->operacao_comercial_id) == $o->id) ? 'selected' : '' ?>><?= $o->nome_operacao ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="natureza_contribuinte" id="natureza_contribuinte">
                                ...
                                <option value="nao_inscrito" <?= (set_value('natureza_contribuinte', $result->natureza_contribuinte) == 'nao_inscrito') ? 'selected' : '' ?>>Não Inscrito</option>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
