                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" id="operacao_comercial_id" name="operacao_comercial_id" required>
                                            ...
                                            <option value="<?php echo $o->id; ?>" <?php echo (isset($faturamento->operacao_comercial_id) && $o->id == $faturamento->operacao_comercial_id) ? 'selected' : ''; ?>><?php echo $o->nome_operacao; ?></option>
                                            <?php } ?>
                                        </select>
                                </div>
                                <div class="col-md-4">
