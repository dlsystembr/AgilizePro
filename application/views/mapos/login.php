...
<body>
  <div class="main-login">
    <div class="left-login">
      ...
      <img src="<?php echo base_url() ?>assets/img/dashboard-animate.png" class="left-login-image" alt="AgilizePro - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
          ...
          <div class="container">
            <div class="card">
              <div class="content">
                ...
                <div class="links-uteis"><a href="https://dlsystem.com.br">
                    <p><?= date('Y'); ?> &copy; DL System Tecnologia</p>
                  </a>
                </div>
