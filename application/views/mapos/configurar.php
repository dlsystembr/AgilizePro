    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#menu8">Tributação</a></li>
            </ul>
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="control-group">
                            <label for="control_baixa" class="control-label">Controle de Baixa</label>
                            <div class="controls">
                                <select name="control_baixa" id="control_baixa">
                                    <option value="1" <?= isset($configuration['control_baixa']) && $configuration['control_baixa'] == '1' ? 'selected' : ''; ?>>Ativar</option>
                                    <option value="0" <?= isset($configuration['control_baixa']) && $configuration['control_baixa'] == '0' ? 'selected' : ''; ?>>Desativar</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="control_editos" id="control_editos">
                                    <option value="1" <?= isset($configuration['control_editos']) && $configuration['control_editos'] == '1' ? 'selected' : ''; ?>>Ativar</option>
                                    <option value="0" <?= isset($configuration['control_editos']) && $configuration['control_editos'] == '0' ? 'selected' : ''; ?>>Desativar</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="control_edit_vendas" id="control_edit_vendas">
                                    <option value="1" <?= isset($configuration['control_edit_vendas']) && $configuration['control_edit_vendas'] == '1' ? 'selected' : ''; ?>>Ativar</option>
                                    <option value="0" <?= isset($configuration['control_edit_vendas']) && $configuration['control_edit_vendas'] == '0' ? 'selected' : ''; ?>>Desativar</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="pix_key" value="<?= isset($configuration['pix_key']) ? $configuration['pix_key'] : ''; ?>">
                    ...
                    <div id="menu3" class="tab-pane fade">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="os_notification" id="os_notification">
                                    ...
                                    <option value="cliente" <?= isset($configuration['os_notification']) && $configuration['os_notification'] == 'cliente' ? 'selected' : ''; ?>>Somente o Cliente</option>
                                    <option value="tecnico" <?= isset($configuration['os_notification']) && $configuration['os_notification'] == 'tecnico' ? 'selected' : ''; ?>>Somente o Técnico</option>
                                    <option value="emitente" <?= isset($configuration['os_notification']) && $configuration['os_notification'] == 'emitente' ? 'selected' : ''; ?>>Somente o Emitente</option>
                                    <option value="nenhum" <?= isset($configuration['os_notification']) && $configuration['os_notification'] == 'nenhum' ? 'selected' : ''; ?>>Não Notificar</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea rows="5" cols="20" name="notifica_whats" id="notifica_whats" placeholder="Use as tags abaixo para criar seu texto!" style="margin: 0px; width: 606px; height: 86px;"><?= isset($configuration['notifica_whats']) ? $configuration['notifica_whats'] : ''; ?></textarea>
                            </div>
                            <div class="span3">
                        ...
                        <div class="control-group">
                            <div class="span8" style="margin-left: 3em;">
                                ...
                                <div class="controls">
                                    <select name="control_2vias" id="control_2vias">
                                        <option value="1">Ativar</option>
                                        <option value="0" <?= isset($configuration['control_2vias']) && $configuration['control_2vias'] == '0' ? 'selected' : ''; ?>>Desativar</option>
                                    </select>
                            ...
                            <div class="span8">
                                ...
                                <div class="span10" style="margin-left: 3em;">
                                    <?php 
                                    $os_status_list = isset($configuration['os_status_list']) ? json_decode($configuration['os_status_list'], true) : [];
                                    if (!is_array($os_status_list)) {
                                        $os_status_list = [];
                                    }
                                    ?>
                                    <label> <input <?= in_array("Aberto", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aberto"> <span class="lbl"> Aberto</span> </label>
                                    <label> <input <?= in_array("Orçamento", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Orçamento"> <span class="lbl"> Orçamento</span> </label>
                                    <label> <input <?= in_array("Negociação", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Negociação"> <span class="lbl"> Negociação</span> </label>
                                    <label> <input <?= in_array("Aprovado", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aprovado"> <span class="lbl"> Aprovado </span> </label>
                                    <label> <input <?= in_array("Aguardando Peças", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aguardando Peças"> <span class="lbl"> Aguardando Peças </span> </label>
                                    <label> <input <?= in_array("Em Andamento", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Em Andamento"> <span class="lbl"> Em Andamento</span> </label>
                                    <label> <input <?= in_array("Finalizado", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Finalizado"> <span class="lbl"> Finalizado</span> </label>
                                    <label> <input <?= in_array("Faturado", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Faturado"> <span class="lbl"> Faturado</span> </label>
                                    <label> <input <?= in_array("Cancelado", $os_status_list) ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Cancelado"> <span class="lbl"> Cancelado</span> </label>
                                </div>
                            </div>
                            <div class="span8">
                    ...
                    <div id="menu8" class="tab-pane fade">
                        <div class="control-group">
                            <label for="tributacao_produto" class="control-label">Tributação de Produtos</label>
                            <div class="controls">
                                <select name="tributacao_produto" id="tributacao_produto">
                                    <option value="1">Ativar</option>
                                    <option value="0" <?= isset($configuration['tributacao_produto']) && $configuration['tributacao_produto'] == '0' ? 'selected' : ''; ?>>Desativar</option>
                                </select>
                                <span class="help-inline">Ativar ou desativar o controle de tributação de produtos.</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="regime_tributario" class="control-label">Regime Tributário</label>
                            <div class="controls">
                                <select name="regime_tributario" id="regime_tributario">
                                    <option value="Simples Nacional" <?= (isset($configuration['regime_tributario']) && $configuration['regime_tributario'] == 'Simples Nacional') ? 'selected' : ''; ?>>Simples Nacional</option>
                                    <option value="Lucro Presumido" <?= (isset($configuration['regime_tributario']) && $configuration['regime_tributario'] == 'Lucro Presumido') ? 'selected' : ''; ?>>Lucro Presumido</option>
                                    <option value="Lucro Real" <?= (isset($configuration['regime_tributario']) && $configuration['regime_tributario'] == 'Lucro Real') ? 'selected' : ''; ?>>Lucro Real</option>
                                </select>
                                <span class="help-inline">Selecione o regime tributário principal da empresa.</span>
                            </div>
                        </div>
                        <div class="control-group" id="mensagemSimplesNacionalGroup" style="display: <?= (isset($configuration['regime_tributario']) && $configuration['regime_tributario'] == 'Simples Nacional') ? 'block' : 'none' ?>;">
                            <label for="mensagem_simples_nacional" class="control-label">Mensagem do Simples Nacional</label>
                            <div class="controls">
                                <input type="text" name="mensagem_simples_nacional" id="mensagem_simples_nacional" value="<?= isset($configuration['mensagem_simples_nacional']) ? $configuration['mensagem_simples_nacional'] : '' ?>">
                                <span class="help-inline">Mensagem personalizada para notas fiscais do Simples Nacional.</span>
                            </div>
                        </div>
                        <div class="control-group" id="aliq_cred_icms_group" style="display: none;">
                            <label for="aliq_cred_icms" class="control-label">Alíquota Crédito ICMS (%)</label>
                            <div class="controls">
                                <input type="text" name="aliq_cred_icms" id="aliq_cred_icms" value="<?= isset($configuration['aliq_cred_icms']) ? $configuration['aliq_cred_icms'] : '0,00'; ?>" class="money" />
                                <span class="help-inline">Alíquota de crédito ICMS para Simples Nacional.</span>
                            </div>
                        </div>
                        <div class="form-actions">
                            <div class="span8">
...
<script>
    ...
    $(document).ready(function() {
        $('#formConfigurar').submit(function(e) {
            e.preventDefault();
            
            var formData = $(this).serialize();

            $.ajax({
                url: '<?php echo site_url("mapos/salvarConfiguracoes"); ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
        ...
        function toggleMensagemSimples() {
            if ($('#regime_tributario').val() === 'Simples Nacional') {
                $('#mensagemSimplesNacionalGroup').show();
                $('#aliq_cred_icms_group').show();
            } else {
                $('#mensagemSimplesNacionalGroup').hide();
                $('#aliq_cred_icms_group').hide();
            }
        }
        $('#regime_tributario').change(toggleMensagemSimples);
        toggleMensagemSimples();

        // Initialize money mask for aliq_cred_icms
        $.getScript('<?= base_url() ?>assets/js/jquery.mask.min.js', function(){
            $('#aliq_cred_icms').mask('#.##0,00', {reverse: true});
        });
    });
</script>
